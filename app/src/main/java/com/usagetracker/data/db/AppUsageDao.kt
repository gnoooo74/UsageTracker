...
interface AppUsageDao {
    ...
    /** 시스템 앱 제외한 기록만 */
    @Query("SELECT * FROM app_usage WHERE date = :date AND isSystemApp = 0 ORDER BY foregroundTime DESC")
    fun getByDateFiltered(date: String): LiveData<List<AppUsageEntity>>
